...
= 16 February 2019 =
* Centre quote icon above the quote block, regardless of text alignment.

= 7 February 2019 =
* Correct button appearance.

= 5 February 2019 =
* Update More menu to work on click when displaying the tablet size on desktop, rather than just on touch.
...
= 19 March 2018 =
* Refactoring dropdown menu for better usability on touch devices.
